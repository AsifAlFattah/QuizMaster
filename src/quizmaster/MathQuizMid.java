 ...
 * @author asif
 */
public class MathQuizMid extends javax.swing.JFrame {

    /**
     * Creates new form MathQuizMid
     */
        //Createing Button Group
    ButtonGroup bg = new ButtonGroup();
    
    //Questions
    String[] QuesOfMathMid = {"Solve 3 + 6 × ( 5 + 4) ÷ 3 – 7","	What is 6% Equals to","What is the slope of a line that passes through the points (-3, 4) and (5, -2)?","What is the value of y in the equation 4x - 3y = 12 if x = 5?","What is the value of x in the equation 5x - 3 = 22 - 2x?","Simplify the expression: 4x - 2(3x - 1)","What is the 8th term of the geometric sequence 2, 6, 18, 54, ...?","What is the area of a circle with a radius of 7.5 cm, rounded to two decimal places?","The square root of 0.0081 is ………… .","10003 – 999 =       …………"};
...
{"-6","8","9","-9","-6"},
{"5","3","4","2","4"},
{"-2x + 2","2x + 2","2x - 2","6x – 2","-2x + 2"},
{"384","162","486","1458","1458"},
{"176.63 sq cm","56.25 sq cm","56.25π sq cm","176.63π sq cm","56.25 sq cm"},
{"0.09","0.9","0.91","0.0009","0.09"},
{"4009","9004","9040","9400","9004"} };
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextActionPerformed
        ...
        if(index==QuesOfMathMid.length){
            ...
            try{
                ...
                jLabelQuestion.setText("<HTML>" + qNo + ". " + QuesOfMathMid[index] + "<HTML>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MathQuizMid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MathQuizMid().setVisible(true);
            }
        });
    }
