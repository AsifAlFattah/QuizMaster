 ...
 * @author asif
 */
public class SportsQuizFootball extends javax.swing.JFrame {

    /**
     * Creates new form SportsQuizFootball
     */
        //Createing Button Group
    ButtonGroup bg = new ButtonGroup();
    
    //Questions
    String[] QuesOfFootball = {"What is the maximum number of substitutions allowed in a football match?","Which team has won the most UEFA Champions League titles?","Which team has won the most English Premier League titles?","Who won the UEFA Champions League in 2022?","Which country hosted the 2018 FIFA World Cup?","Which country has won the most FIFA World Cup tournaments?","Which team won the UEFA Euro 2020 tournament?","Which country won the 2018 FIFA World Cup?","Which player has won the Ballon d'Or award the most times?","Which country won the UEFA European Championship in 2016?"};
    
    //Options
    String[][] options = { {"3","4","5","6","5"},{"Real Madrid","Barcelona","Manchester United","Liverpool","Real Madrid"},{"Manchester United","Liverpool","Chelsea","Arsenal","Manchester United"},{"Chelsea","Manchester City","Paris Saint-Germain","Real Madrid","Real Madrid"},{"Brazil","Germany","Russia","South Africa","Russia"},{"Brazil","Germany","Argentina","Italy","Brazil"},{"Portugal","Italy","France","England","Italy"},{"Germany","Brazil","France","Spain","France"},{"Lionel Messi","Cristiano Ronaldo","Michel Platini","Johan Cruyff","Lionel Messi"},{"Germany","Spain","Portugal","France","Portugal"} };
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextActionPerformed
        ...
        if(index==QuesOfFootball.length){
            enableRButtons(false);
            ...
            try{
                ...
                jLabelQuestion.setText("<HTML>" + qNo + ". " + QuesOfFootball[index] + "<HTML>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SportsQuizFootball.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SportsQuizFootball().setVisible(true);
            }
        });
    }
