 ...
 * @author asif
 */
public class IqQuizEasy extends javax.swing.JFrame {

    /**
     * Creates new form IqQuizEasy
     */
    ...
    //Questions
    String[] QuesOfIQEasy = {"How many months have 28 days?","A man gave one son 10 cents and another son was given 15 cents. What time is it?","What is the next number in the sequence: 1, 3, 6, 10, 15, __","If a doctor gives you 3 pills and tells you to take one every half hour, how long will it take you to finish all the pills?","a chicken says, 'All chickens are liars', is the chicken telling the truth?","A plane crashes on the border of Canada and the United States. Where would the survivors be buried?","If 6 eggs take 6 minutes to boil, how many minutes will it take to boil 12 eggs?","If A is taller than B and B is taller than C, who is the shortest?","Which number should come next in the series? 1, 4, 9, 16, 25, ?","What letter comes next in the following sequence: A, B, D, G, K, ?"};
    
    //Options
    String[][] options = { 
{"1","2","11","12","12"},
{"3:25 PM","12:45 AM","7:15 PM","None of the above","None of the above"},
{"19","20","21","22","21"},
{"30 minutes","1 hour","1.5 hours","2 hours","1 hour"},
{" Yes","No","Can't say for sure","None of the above","No"},
{"Canada","United States","Survivors are not buried","It depends","Survivors are not buried"},
{"6","8","10","12","6"},
{"A","B","C","Cannot be determined","C"},
{"36","40","49","64","36"},
{"N","O","P","Q","P"} };
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextActionPerformed
        ...
        if(index==QuesOfIQEasy.length){
            ...
            try{
                ...
                jLabelQuestion.setText("<HTML>" + qNo + ". " + QuesOfIQEasy[index] + "<HTML>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IqQuizEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IqQuizEasy().setVisible(true);
            }
        });
    }
