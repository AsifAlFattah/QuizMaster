 ...
 * @author asif
 */
public class SportsQuizTennis extends javax.swing.JFrame {

    /**
     * Creates new form SportsQuizTennis
     */
        //Createing Button Group
    ButtonGroup bg = new ButtonGroup();
    
    //Questions
    String[] QuesOfTennis = {"How many sets are played in a men's singles tennis match?","Who is the male tennis player with the most Grand Slam titles in history?","What is the name of the Australian tennis player who retired in 2020 after winning 23 Grand Slam titles?","In doubles tennis, how many players are on a match?","Which country has won the most Davis Cup titles in men's tennis?","Who won the 2020 French Open men's singles title?","What is the name of the tennis shot in which the player hits the ball with their backhand while jumping in the air?","In which year did Roger Federer win his first Grand Slam singles title?","What is the term used for a tie-break in tennis?","Who won the women's singles title at the 2021 Wimbledon Championships?"};
    
    //Options
    String[][] options = { {"2","3","4","5","5"},{"Rafael Nadal","Roger Federer","Novak Djokovic","Pete Sampras","Roger Federer"},{"Maria Sharapova","Victoria Azarenka","Li Na","Serena Williams","Serena Williams"},{"1","2","3","4","4"},{"USA","Spain","France","Australia","USA"},{"Rafael Nadal","Novak Djokovic","Roger Federer","Dominic Thiem","Rafael Nadal"},{"Slice","Lob","Smash","Jumping Backhand","Jumping Backhand"},{"2000","2003","2006","2009","2003"},{"Super Set","Advantage Set","Championship Tiebreak","Match Break","Championship Tiebreak"},{"Naomi Osaka","Simona Halep","Ashleigh Barty","Serena Williams","Ashleigh Barty"} };
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextActionPerformed
        ...
        if(index==QuesOfTennis.length){
            ...
            try{
                ...
                jLabelQuestion.setText("<HTML>" + qNo + ". " + QuesOfTennis[index] + "<HTML>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SportsQuizTennis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SportsQuizTennis().setVisible(true);
            }
        });
    }
