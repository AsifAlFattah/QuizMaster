 ...
 * @author asif
 */
public class IqQuizMid extends javax.swing.JFrame {

    /**
     * Creates new form IqQuizMid
     */
    ...
    //Questions
    String[] QuesOfIQMid = {"How many sides does a pentagon have?","Which of the following numbers is an odd number?","How many zeros are there in one hundred thousand?","Which of the following words is spelled incorrectly?","If a train travels 100 miles in 2 hours, how fast is it going?","Which of the following is the smallest planet in our solar system?","What is the square root of 64?","Which of the following is a prime number?","Which of the following countries is not located in Europe?","Which of the following is the capital of Australia?"};
    
    //Options
    String[][] options = { {"4","5","6","7","5"},{"12","15","18","20","15"},{"1","2","3","4","3"},{"Accommodate","Embarrass","Conscientious","Recieve","Recieve"},{"25 mph","50 mph","75 mph","100 mph","50 mph"},{"Earth","Jupiter","Mercury","Venus","Mercury"},{"4","8","16","64","8"},{"10","15","23","27","23"},{"France","Germany","Japan","Spain","Japan"},{"Sydney","Melbourne","Canberra","Perth","Canberra"} };
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextActionPerformed
        ...
        if(index==QuesOfIQMid.length){
            ...
            try{
                ...
                jLabelQuestion.setText("<HTML>" + qNo + ". " + QuesOfIQMid[index] + "<HTML>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IqQuizMid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
