 ...
 * @author asif
 */
public class BDQuizHard extends javax.swing.JFrame {

    /**
     * Creates new form BDQuizHard
     */
        //Createing Button Group
    ButtonGroup bg = new ButtonGroup();
    
    //Questions
    String[] QuesOfBDHard = {"Which river forms the natural boundary between Bangladesh and India?","Who was the first Prime Minister of Bangladesh after its independence in 1971?","What was the original name of the city of Dhaka? ","What is the name of the largest river delta in the world, which is located in Bangladesh?","Who was the first Bangladeshi to climb Mount Everest?","Who designed the Bangladesh National Parliament Building, which is known for its unique architectural design?","What is the name of the largest natural lake in Bangladesh, which is located in the Rangamati Hill District?","Who is the first female pilot of Bangladesh","Which is the second country to recognize Bangladesh?","Which district of Bangladesh was part of Assam?"};
    
    //Options
    String[][] options = { 
{"Teesta River","Brahmaputra River","Ganges River","Meghna River","Teesta River"},
{"Sheikh Mujibur Rahman","Ziaur Rahman","Tajuddin Ahmad","Khaleda Zia","Tajuddin Ahmad"},
{"Jahangir Nagar ","Shahjahanabad","Murshidabad","Agra","Jahangir Nagar "},
{"Ganges Delta","Mekong Delta","Nile Delta","Mississippi Delta","Ganges Delta"},
{"Nishat Majumdar ","M. A. Muhit","Musa Ibrahim ","Wasfia Nazreen ","Musa Ibrahim "},
{"Frank Gehry","I. M. Pei","Santiago Calatrava","Louis Kahn","Louis Kahn"},
{"Kaptai Lake","Dhanmondi Lake","Purbani Lake","Gulshan Lake","Kaptai Lake"},
{"Nayma Haque","Kaniz fatema Roksana","Nasim begum","None of these","Kaniz fatema Roksana"},
{"India ","Nepal","Bhutan","China","Bhutan"},
{"Chittagong","Sylhet","Rangpur"," Khulna","Sylhet"} };
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextActionPerformed
        ...
        if(index==QuesOfBDHard.length){
            ...
            try{
                ...
                jLabelQuestion.setText("<HTML>" + qNo + ". " + QuesOfBDHard[index] + "<HTML>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BDQuizHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BDQuizHard().setVisible(true);
            }
        });
    }
