 ...
 * @author asif
 */
public class MathQuizEasy extends javax.swing.JFrame {

    /**
     * Creates new form MathQuizEasy
     */
    ...
    //Questions
    String[] QuesOfMathEasy = {"What is the value of x if 2x + 3 = 9?","What is the sum of the first five counting numbers?","How many sides does a rectangle have?","What is the value of pi (π) rounded to two decimal places?","What is the value of 2 to the power of 3?","What is the product of 3 and 8?","The product of 131 x 5 x 0 x 5","What is the value of 4 squared?","What is the result of dividing 20 by 5?","What is the value of 10 minus 6?"};
...
{"2","3","4","5","4"} };
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextActionPerformed
        ...
        if(index==QuesOfMathEasy.length){
            enableRButtons(false);
            ...
            try{
                ...
                jLabelQuestion.setText("<HTML>" + qNo + ". " + QuesOfMathEasy[index] + "<HTML>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MathQuizEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MathQuizEasy().setVisible(true);
            }
        });
    }
