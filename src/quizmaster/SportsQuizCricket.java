 ...
 * @author asif
 */
public class SportsQuizCricket extends javax.swing.JFrame {

    /**
     * Creates new form SportsQuizCricket
     */
        //Createing Button Group
    ButtonGroup bg = new ButtonGroup();
    
    //Questions
    String[] QuesOfCricket = {"What is the highest individual score by a batsman in test cricket?","Who is the leading wicket-taker in ODI cricket?","Which team won the first ICC T20 World Cup in 2007?","In which year was the first One Day International (ODI) played?","Who is the fastest bowler to reach 300 Test wickets?","Who has scored the most runs in international cricket?","What is the highest team total in a Test match innings?","Who is Bangladesh's leading wicket-taker in ODI cricket?","Which team won the most ICC Cricket World Cup tournaments?","Against which team did Bangladesh win their first Test match?"};
    
    //Options
    String[][] options = { {"400","375","501","365","400"},{"Wasim Akram","Glenn McGrath","Muttiah Muralitharan","Anil Kumble","Muttiah Muralitharan"},{"Australia","England","Pakistan","Sri Lanka","Pakistan"},{"1968","1971","1983","1992","1971"},{"Shane Warne","Glenn McGrath","Curtly Ambrose","Dennis Lillee","Dennis Lillee"},{"Sachin Tendulkar","Ricky Ponting","Brian Lara","Kumar Sangakkara","Sachin Tendulkar"},{"952/6","903/7d","849","1036/3d","1036/3d"},{"Mashrafe Mortaza","Shakib Al Hasan","Mustafizur Rahman","Taskin Ahmed","Shakib Al Hasan"},{"Australia","West Indies","India","England","Australia"},{"West Indies","Zimbabwe","Pakistan","England","Zimbabwe"} };
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextActionPerformed
        ...
        if(index==QuesOfCricket.length){
            ...
            try{
                ...
                jLabelQuestion.setText("<HTML>" + qNo + ". " + QuesOfCricket[index] + "<HTML>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SportsQuizCricket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SportsQuizCricket().setVisible(true);
            }
        });
    }
